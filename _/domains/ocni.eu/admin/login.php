			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-wrapper">
			        <div class="box">
                      ...
                      <h6 style="font-size:15px;">Přihlášení do administrace webu</h6>
			                <input class="form-control" type="text" name="name" placeholder="Přihlašovací jméno">
